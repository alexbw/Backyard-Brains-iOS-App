...

{
    ...
    double dutyCycleInput = lja->dutyCycle; //6.12
    double theta = lja->theta;
    double outputFrequency = lja->outputFrequency;
...
@synthesize sampleRate, pulseProgress, theta, outputFrequency;
@synthesize delegate;
...
#define defaultOutputFrequency 11000 //Hz
...
- (id)init //WithDictionary:(NSDictionary *)dictionary
{
	...
	if ((self = [super init])) {
        ...
        self.outputFrequency = defaultOutputFrequency;
